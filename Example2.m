% in this example, we add a second plate
...
% plate parameters
P=cell(2,1); % cell capturing parameters for each plate
...
P{1}.a0=-1-0.2i; % left end-point of plate
P{1}.b0=1-0.2i; % left end-point of plate
